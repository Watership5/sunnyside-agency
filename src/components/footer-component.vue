...
<template>
  <footer class="footer">
    <div class="imgContainer">
      <img :src="milk" alt="gallery-milk" width="480"/>
      <img :src="orange" alt="gallery-orange" width="480"/>

      <img :src="cone" alt="gallery-cone" width="480"/>

      <img :src="sugarcubes" alt="gallery-sugarcubes" width="480"/>
